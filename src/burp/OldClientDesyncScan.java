    ...
    List<IScanIssue> doScan(byte[] baseReq, IHttpService service) {
        ...
        for (String path: paths) {
            ...
            for (int i=0; i<4; i++) {
                ...
                // ISO-8859-1 preserves raw HTTP bytes verbatim; the platform default
                // charset corrupts high-bit smuggling payload bytes on UTF-8 JVMs.
                helper.queue(new String(attack, StandardCharsets.ISO_8859_1));
                helper.queue(new String(followup, StandardCharsets.ISO_8859_1));
